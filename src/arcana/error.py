...
class ErrorCode(str, Enum):
    ...
    RETURN_TYPE_MISMATCH = "E0205_RETURN_TYPE_MISMATCH"
    RETURN_OUTSIDE_FUNCTION = "E0206_RETURN_OUTSIDE_FUNCTION"
    RETURN_TYPE_NIHIL = "E0207_RETURN_TYPE_NIHIL"
...
E_ARG_COUNT_MISMATCH = ErrorCode.ARG_COUNT_MISMATCH.value
E_TYPE_MISMATCH = ErrorCode.TYPE_MISMATCH.value
E_RETURN_TYPE_MISMATCH = ErrorCode.RETURN_TYPE_MISMATCH.value
E_RETURN_OUTSIDE_FUNCTION = ErrorCode.RETURN_OUTSIDE_FUNCTION.value
E_RETURN_TYPE_NIHIL = ErrorCode.RETURN_TYPE_NIHIL.value
